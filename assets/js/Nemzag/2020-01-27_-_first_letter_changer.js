...
const CONVERTER_INPUT = document.getElementById("converterInput");
...
document.getElementById("converterInput").addEventListener("keyup", changeFirstLetterFunction);
...
function changeFirstLetterFunction() {
    ...
    $text = CONVERTER_INPUT.value.substring(1, 100);
